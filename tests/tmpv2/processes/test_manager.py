...
from kapy.tmpv2.processes import (
    ProcessError,
    ProcessManager,
    ProcessSpec,
    TerminalSize,
...
from kapy.tmpv2.processes.gc import gc_processes
from kapy.tmpv2.processes.models import ProcessRow
from kapy.tmpv2.processes.repository import ProcessRepository
...
async def test_gc_failures_keep_deleting_rows_then_allow_id_reuse(
    ...
    try:
        with monkeypatch.context() as patch:
            ...
            patch.setattr("kapy.tmpv2.processes.gc.shutil.rmtree", fail_remove)

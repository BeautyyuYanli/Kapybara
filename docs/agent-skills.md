...
including the history view schema, creation-time output mode, session ID and machine selection,
are supplied each run. Association does not guarantee that a machine is online.

...
of SDK error recovery. The thin runner owns the lease, heartbeat, task constraint,
graph lifetime and queued/cancel scheduling; it never writes SDK private history.
